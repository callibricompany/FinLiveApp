...
import { AppRegistry, Animated, Easing, Image, Text, View, StyleSheet, TouchableOpacity, ScrollView, ImageBackground } from 'react-native';
...
const categoryTouts = [ //the touts are the clickable image items that hold our links
  { image: 'https://images3.campingworld.com/CampingWorld/portal/outdoor/tent_camping.jpg', title: 'Category1', links: categoryLinks },
  { image: 'https://images3.campingworld.com/CampingWorld/portal/outdoor/tent_camping.jpg', title: 'Category2', links: categoryLinks },
  { image: 'https://images3.campingworld.com/CampingWorld/portal/outdoor/tent_camping.jpg', title: 'Category3', links: categoryLinks },
]
...
export default class FLScrollAccordion extends React.PureComponent { //scroll accordion is our parent class - it renders the touts and their subcategories
